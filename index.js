...
function getLastReview(array) {
  return `${array[reviews.length - 1].name} gave the restaurant a ${array[reviews.length - 1].rating} star review, and their feedback was: ${array[reviews.length - 1].feedback}`;
